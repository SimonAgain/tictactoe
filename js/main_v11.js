...
$(document).ready(function() {
  ...
  $('#challengeHuman').on('click', function() {
      gameOver = false;
...
const updateGameStatus = function() {
  if ( thereIsAWinner() ) { // checks for a winner
    ...
    if (currentPlayer === playerX) {
      $('#imageX').attr('src','images/WiCG.gif');
      $('#image0').attr('src','images/player0Loose.gif');
    } else {
      $('#image0').attr('src','images/player0Win.gif');
      $('#imageX').attr('src','images/playerXLoose.gif');
    ;} // end if
...
const playAgain = function() {
  ...
  $('#gameStatus').text(`Player ${currentPlayer}... your turn`);
  $('#imageX').attr('src','images/playerX.gif');
  $('#image0').attr('src','images/tGR.gif');
